...
% ===== XXX_matlab-3 forwards entry =====
global RGMS_XM3
if isempty(RGMS_XM3)
    RGMS_XM3 = struct('n_fwd',0,'n_vbx',0,'n_ind',0,'n_efe_rec',0,'N_vals',[],'t_vals',[]);
end
RGMS_XM3.n_fwd = RGMS_XM3.n_fwd + 1;
if RGMS_XM3.n_fwd <= 5 || mod(RGMS_XM3.n_fwd, 64) == 0
    fprintf(1, '[XM3] forwards n=%d t=%g T=%g N=%g m=%g\\n', RGMS_XM3.n_fwd, t, T, N, m);
end
RGMS_XM3.N_vals(end+1) = N; %#ok<AGROW>
RGMS_XM3.t_vals(end+1) = t; %#ok<AGROW>
% ===== end XM3 entry =====
...
% ===== XXX_matlab-3 VBX =====
global RGMS_XM3
if ~isempty(RGMS_XM3), RGMS_XM3.n_vbx = RGMS_XM3.n_vbx + 1; end
% ===== end XM3 VBX =====
[Q,F]    = spm_VBX(O(m,:,t),P(m,:,t),A(m,:),id{m});

% ===== XXX_matlab-3 P update =====
global RGMS_XM3
if ~isempty(RGMS_XM3) && RGMS_XM3.n_fwd == 1
    % first forwards: note P cell is updated in place at this t
    fprintf(1, '[XM3] first VBX: assigned P(m,:,t)=Q in-place (t=%g)\\n', t);
end
% ===== end XM3 P =====
P(m,:,t) = Q;
...
% ===== XXX_matlab-3 induction =====
global RGMS_XM3
if ~isempty(RGMS_XM3), RGMS_XM3.n_ind = RGMS_XM3.n_ind + 1; end
% ===== end XM3 induction =====
...
% ===== XXX_matlab-3 EFE recurse =====
global RGMS_XM3
if ~isempty(RGMS_XM3), RGMS_XM3.n_efe_rec = RGMS_XM3.n_efe_rec + 1; end
% ===== end XM3 EFE =====
