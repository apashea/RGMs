function [MDP] = spm_MDP_VB_XXX_debug(MDP,OPTIONS)         % edit
% active inference and learning using belief propagation (factorised)
% FORMAT [MDP] = spm_MDP_VB_XXX_debug(MDP,OPTIONS)
%
...
% Karl Friston
% $Id: spm_MDP_VB_XXX.m 8488 2025-01-30 16:03:44Z karl $
...
if size(MDP,2) > 1
    ...
    for i = 1:size(MDP,2)                      % number of trials
        ...
        %------------------------------------------------------------------
        OUT(:,i) = spm_MDP_VB_XXX_debug(MDP(:,i),OPTIONS);       % edit
        fprintf('Update %i\n',i);
...
for t = 1:T
    ...
    for m = M(t,:)
        ...
        if isfield(MDP,'MDP')
            ...
            % update
            %--------------------------------------------------------------
            mdp   = spm_MDP_VB_XXX_debug(mdp);					% edit
