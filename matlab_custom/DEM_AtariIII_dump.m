...
dump_dir = fileparts(mfilename('fullpath'));
rdp_file = fullfile(dump_dir, 'DEMAtariIII_RDP_before_fourth_spm_MDP_VB_XXX_debug.mat');
...
%%%%%%%%%%%%%%%%%% edit end
PDP   = spm_MDP_VB_XXX_debug(RDP);
%%%%%%%%%%%%%%%%%% edit: dump the fully assembled PDP exactly as it exists after fourth inference call
pdp_file = fullfile(dump_dir, 'DEMAtariIII_PDP_after_fourth_spm_MDP_VB_XXX_debug.mat');
