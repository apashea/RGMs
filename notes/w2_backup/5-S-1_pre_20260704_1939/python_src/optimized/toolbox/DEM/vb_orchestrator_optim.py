...
from python_src.toolbox.DEM import spm_MDP_VB_XXX as _vb_rng
...
_spm_sample = _vb_rng._spm_sample
spm_children = _vb_rng.spm_children
_spm_norm = _vb_rng._spm_norm
_spm_action = _vb_rng._spm_action
_spm_log = _vb_rng._spm_log
_spm_one_hot = _vb_rng._spm_one_hot
_unwrap_gp_elem = _vb_rng._unwrap_gp_elem
_vb_gp_transition_column = _vb_rng._vb_gp_transition_column
_vb_gp_A_outcome_column = _vb_rng._vb_gp_A_outcome_column
_vb_gp_outcome_sample_index = _vb_rng._vb_gp_outcome_sample_index
_tensor_nonempty = _vb_rng._tensor_nonempty
_default_options_vb = _vb_rng._default_options_vb
_spm_norm_inplace = _vb_rng._spm_norm_inplace
_spm_wnorm = _vb_rng._spm_wnorm
_spm_hnorm = _vb_rng._spm_hnorm
_vb_workspace_A_like_mdp_shape = _vb_rng._vb_workspace_A_like_mdp_shape
        ...
        if t_idx > 0:
            ...
            if _vb_rng._vb_dump_active():
                ...
                _vb_rng._entry12_record_phase(
                    ...
                    extra={
                        "k_policy": k_pol,
                        "Pu": _vb_rng._vb_as_float64_array(pu_rec).ravel().tolist(),
                    },
                )
