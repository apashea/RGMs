...
def ws_refill_from_bundle(ws: VbWorkspace, bundle: dict[str, Any]) -> None:
    """Reset existing workspace columns from legacy bundle (ENDGAME-2 child kernel — no realloc)."""
    t_int = int(bundle["T"])
    if t_int != ws.T:
