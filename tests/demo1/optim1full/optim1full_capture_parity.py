#!/usr/bin/env python3
"""OPTIM1FULL — MATLAB ``capture_optim1full_parity`` (MI + call-3/4 VB fixtures)."""
...
def main() -> int:
    ...
    try:
        ...
        eng.eval(
            "DEMAtariIII_entry12_dump_all_subentries('capture_optim1full_parity');",
            nargout=0,
        )
    finally:
        eng.quit()
    print("[optim1full_capture_parity] done", file=sys.stderr, flush=True)
    return 0
