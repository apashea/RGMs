"""``DEM_AtariIII.m`` L394–402 — Active inference (with compression)."""
...
_FIGURE_TITLE = "Active inference (with compression)"
_NT = 4
_MOVIE = 0
_HITS_Y = -2.0


def dem_atariiii_plot_with_compression_rgb(
    pdp: Any,
    ...
    *,
    ...
    """Post-VB hierarchical RGB + hits — ``spm_show_RGB(PDP,RGB,4,0)``."""
